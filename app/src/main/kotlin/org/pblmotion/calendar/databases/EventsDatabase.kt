package org.pblmotion.calendar.databases
...
import org.pblmotion.calendar.helpers.Converters
...
abstract class EventsDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_11_12 = object : Migration(11, 12) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("CREATE INDEX IF NOT EXISTS `index_tasks_task_id` ON `tasks` (`task_id`)")
            }
        }
    }
}
