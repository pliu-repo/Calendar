...
import org.pblmotion.calendar.activities.CalendarPickerActivity
import org.pblmotion.calendar.activities.EventActivity
import org.pblmotion.calendar.activities.SnoozeReminderActivity
import org.pblmotion.calendar.activities.TaskActivity
import org.pblmotion.calendar.databases.EventsDatabase
import org.pblmotion.calendar.databinding.DayMonthlyEventViewBinding
import org.pblmotion.calendar.helpers.ACTION_MARK_COMPLETED
import org.pblmotion.calendar.helpers.AUTOMATIC_BACKUP_REQUEST_CODE
import org.pblmotion.calendar.helpers.CalDAVHelper
import org.pblmotion.calendar.helpers.Config
...
import org.pblmotion.calendar.helpers.DUMMY_ALARM_REQUEST_CODE
import org.pblmotion.calendar.helpers.EVENT_ID
import org.pblmotion.calendar.helpers.EVENT_OCCURRENCE_TS
import org.pblmotion.calendar.helpers.EventsHelper
...
import org.pblmotion.calendar.helpers.MyWidgetDateProvider
import org.pblmotion.calendar.helpers.MyWidgetListProvider
import org.pblmotion.calendar.helpers.MyWidgetMonthlyProvider
...
import org.pblmotion.calendar.helpers.SCHEDULE_CALDAV_REQUEST_CODE
...
import org.pblmotion.calendar.helpers.getNextAutoBackupTime
...
import org.pblmotion.calendar.interfaces.WidgetsDao
...
import org.pblmotion.calendar.models.Task
import org.pblmotion.calendar.receivers.AutomaticBackupReceiver
import org.pblmotion.calendar.receivers.CalDAVSyncReceiver
import org.pblmotion.calendar.receivers.DummyAlarmReceiver
import org.pblmotion.calendar.receivers.NotificationReceiver
import org.pblmotion.calendar.services.MarkCompletedService
import org.pblmotion.calendar.services.SnoozeService
    ...
    day.dayEvents.sortedWith(compareBy<Event> {
        ...
        DayMonthlyEventViewBinding.inflate(LayoutInflater.from(this)).apply {
            ...
            val taskifyMeta = if (config.taskifyEventsMode && !it.isTask()) {
                org.pblmotion.calendar.helpers.TaskifyHelper.parseTitle(it.title, taskifyModeEnabled = true)
            } else {
                null
            }
