...
import org.pblmotion.calendar.adapters.EventListAdapter
import org.pblmotion.calendar.adapters.QuickFilterCalendarAdapter
import org.pblmotion.calendar.databases.EventsDatabase
import org.pblmotion.calendar.databinding.ActivityMainBinding
import org.pblmotion.calendar.dialogs.SelectCalendarsDialog
import org.pblmotion.calendar.dialogs.SelectHolidayTypesDialog
import org.pblmotion.calendar.dialogs.SetRemindersDialog
import org.pblmotion.calendar.extensions.addImportIdsToTasks
...
import org.pblmotion.calendar.fragments.DayFragmentsHolder
import org.pblmotion.calendar.fragments.EventListFragment
import org.pblmotion.calendar.fragments.MonthDayFragmentsHolder
...
import org.pblmotion.calendar.helpers.FETCH_INTERVAL
...
import org.pblmotion.calendar.helpers.Formatter.DAYCODE_PATTERN
import org.pblmotion.calendar.helpers.HOLIDAY_EVENT
import org.pblmotion.calendar.helpers.HolidayHelper
import org.pblmotion.calendar.helpers.INITIAL_EVENTS
import org.pblmotion.calendar.helpers.IS_TASK
import org.pblmotion.calendar.helpers.IcsImporter
import org.pblmotion.calendar.helpers.IcsImporter.ImportResult
import org.pblmotion.calendar.helpers.LAST_VIEW
import org.pblmotion.calendar.helpers.MAX_SEARCH_YEAR
import org.pblmotion.calendar.helpers.MIN_EVENTS_TRESHOLD
import org.pblmotion.calendar.helpers.MONTHLY_DAILY_VIEW
import org.pblmotion.calendar.helpers.MONTHLY_VIEW
import org.pblmotion.calendar.helpers.OTHER_EVENT
import org.pblmotion.calendar.helpers.REPEAT_SAME_DAY
import org.pblmotion.calendar.helpers.SHORTCUT_NEW_EVENT
import org.pblmotion.calendar.helpers.SHORTCUT_NEW_TASK
import org.pblmotion.calendar.helpers.SOURCE_CONTACT_ANNIVERSARY
import org.pblmotion.calendar.helpers.SOURCE_CONTACT_BIRTHDAY
import org.pblmotion.calendar.helpers.UPDATE_BOTTOM
...
import org.pblmotion.calendar.helpers.YEAR_TO_OPEN
import org.pblmotion.calendar.helpers.getActivityToOpen
import org.pblmotion.calendar.jobs.CalDAVUpdateListener
import org.pblmotion.calendar.models.Event
import org.pblmotion.calendar.models.HolidayInfo
...
class MainActivity : SimpleActivity(), RefreshRecyclerViewListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        appLaunched(org.pblmotion.calendar.BuildConfig.APPLICATION_ID)
        setupOptionsMenu()
        refreshMenuItems()
        setupEdgeToEdge(
    ...
    private fun launchAbout() {
        ...
        startAboutActivity(
            ...
            versionName = org.pblmotion.calendar.BuildConfig.VERSION_NAME,
            faqItems = faqItems,
    ...
    private fun checkWhatsNewDialog() {
        arrayListOf<Release>().apply {
            checkWhatsNew(this, org.pblmotion.calendar.BuildConfig.VERSION_CODE)
        }
    }
}
