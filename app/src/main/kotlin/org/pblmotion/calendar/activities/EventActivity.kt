...
import org.pblmotion.calendar.adapters.AutoCompleteTextViewAdapter
import org.pblmotion.calendar.databinding.ActivityEventBinding
import org.pblmotion.calendar.databinding.ItemAttendeeBinding
import org.pblmotion.calendar.dialogs.DeleteEventDialog
import org.pblmotion.calendar.dialogs.EditRepeatingEventDialog
import org.pblmotion.calendar.dialogs.ReminderWarningDialog
import org.pblmotion.calendar.dialogs.RepeatLimitTypePickerDialog
import org.pblmotion.calendar.dialogs.RepeatRuleWeeklyDialog
import org.pblmotion.calendar.dialogs.SelectCalendarDialog
import org.pblmotion.calendar.dialogs.SelectEventColorDialog
import org.pblmotion.calendar.extensions.calDAVHelper
import org.pblmotion.calendar.extensions.calendarsDB
import org.pblmotion.calendar.extensions.cancelNotification
...
import org.pblmotion.calendar.extensions.getRepetitionText
import org.pblmotion.calendar.extensions.getShortDaysFromBitmask
import org.pblmotion.calendar.extensions.isXMonthlyRepetition
import org.pblmotion.calendar.extensions.isXWeeklyRepetition
import org.pblmotion.calendar.extensions.isXYearlyRepetition
import org.pblmotion.calendar.extensions.notifyEvent
import org.pblmotion.calendar.extensions.seconds
import org.pblmotion.calendar.extensions.shareEvents
import org.pblmotion.calendar.extensions.showEventRepeatIntervalDialog
import org.pblmotion.calendar.helpers.ATTENDEES
import org.pblmotion.calendar.helpers.AVAILABILITY
import org.pblmotion.calendar.helpers.CALDAV
import org.pblmotion.calendar.helpers.CALENDAR_ID
import org.pblmotion.calendar.helpers.CLASS
import org.pblmotion.calendar.helpers.CURRENT_TIME_ZONE
import org.pblmotion.calendar.helpers.DELETE_ALL_OCCURRENCES
import org.pblmotion.calendar.helpers.DELETE_FUTURE_OCCURRENCES
import org.pblmotion.calendar.helpers.DELETE_SELECTED_OCCURRENCE
import org.pblmotion.calendar.helpers.EDIT_ALL_OCCURRENCES
import org.pblmotion.calendar.helpers.EDIT_FUTURE_OCCURRENCES
import org.pblmotion.calendar.helpers.EDIT_SELECTED_OCCURRENCE
import org.pblmotion.calendar.helpers.END_TS
import org.pblmotion.calendar.helpers.EVENT
import org.pblmotion.calendar.helpers.EVENT_CALENDAR_ID
import org.pblmotion.calendar.helpers.EVENT_COLOR
...
import org.pblmotion.calendar.helpers.IS_DUPLICATE_INTENT
import org.pblmotion.calendar.helpers.IS_NEW_EVENT
...
import org.pblmotion.calendar.helpers.ORIGINAL_ATTENDEES
import org.pblmotion.calendar.helpers.ORIGINAL_END_TS
import org.pblmotion.calendar.helpers.ORIGINAL_START_TS
import org.pblmotion.calendar.helpers.REMINDER_1_MINUTES
import org.pblmotion.calendar.helpers.REMINDER_1_TYPE
import org.pblmotion.calendar.helpers.REMINDER_2_MINUTES
import org.pblmotion.calendar.helpers.REMINDER_2_TYPE
import org.pblmotion.calendar.helpers.REMINDER_3_MINUTES
import org.pblmotion.calendar.helpers.REMINDER_3_TYPE
import org.pblmotion.calendar.helpers.REMINDER_EMAIL
import org.pblmotion.calendar.helpers.REMINDER_NOTIFICATION
import org.pblmotion.calendar.helpers.REMINDER_OFF
import org.pblmotion.calendar.helpers.REPEAT_INTERVAL
import org.pblmotion.calendar.helpers.REPEAT_LAST_DAY
import org.pblmotion.calendar.helpers.REPEAT_LIMIT
...
import org.pblmotion.calendar.helpers.REPEAT_RULE
import org.pblmotion.calendar.helpers.REPEAT_SAME_DAY
import org.pblmotion.calendar.helpers.SOURCE_IMPORTED_ICS
import org.pblmotion.calendar.helpers.SOURCE_SIMPLE_CALENDAR
import org.pblmotion.calendar.helpers.START_TS
import org.pblmotion.calendar.helpers.STATUS
import org.pblmotion.calendar.helpers.STORED_LOCALLY_ONLY
import org.pblmotion.calendar.helpers.TIME_ZONE
import org.pblmotion.calendar.helpers.generateImportId
import org.pblmotion.calendar.models.Attendee
...
import org.pblmotion.calendar.models.Reminder
...
class EventActivity : SimpleActivity() {
    ...
    private fun setupEditEvent() {
        ...
        if (config.taskifyEventsMode) {
            ...
            val taskMeta = org.pblmotion.calendar.helpers.TaskifyHelper.parseTitle(mEvent.title, taskifyModeEnabled = true)
    ...
    private fun saveEvent() {
        ...
        mEvent.apply {
            ...
            title = if (config.taskifyEventsMode) {
                org.pblmotion.calendar.helpers.TaskifyHelper.encodeTitle(
                    cleanTitle = newTitle,
