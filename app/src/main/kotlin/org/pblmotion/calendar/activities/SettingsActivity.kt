...
import org.pblmotion.calendar.databinding.ActivitySettingsBinding
import org.pblmotion.calendar.dialogs.ExportEventsDialog
import org.pblmotion.calendar.dialogs.ManageAutomaticBackupsDialog
import org.pblmotion.calendar.dialogs.ManageSyncedCalendarsDialog
import org.pblmotion.calendar.dialogs.SelectCalendarDialog
import org.pblmotion.calendar.dialogs.SelectCalendarsDialog
import org.pblmotion.calendar.extensions.calDAVHelper
import org.pblmotion.calendar.extensions.calendarsDB
import org.pblmotion.calendar.extensions.cancelScheduledAutomaticBackup
import org.pblmotion.calendar.extensions.config
import org.pblmotion.calendar.extensions.eventsHelper
import org.pblmotion.calendar.extensions.getSyncedCalDAVCalendars
import org.pblmotion.calendar.extensions.scheduleNextAutomaticBackup
import org.pblmotion.calendar.extensions.showImportEventsDialog
import org.pblmotion.calendar.extensions.tryImportEventsFromFile
import org.pblmotion.calendar.extensions.updateWidgets
import org.pblmotion.calendar.helpers.ALLOW_CHANGING_TIME_ZONES
import org.pblmotion.calendar.helpers.ALLOW_CREATING_TASKS
import org.pblmotion.calendar.helpers.ALLOW_CUSTOMIZE_DAY_COUNT
import org.pblmotion.calendar.helpers.DAILY_VIEW
import org.pblmotion.calendar.helpers.DEFAULT_DURATION
import org.pblmotion.calendar.helpers.DEFAULT_REMINDER_1
import org.pblmotion.calendar.helpers.DEFAULT_REMINDER_2
import org.pblmotion.calendar.helpers.DEFAULT_REMINDER_3
import org.pblmotion.calendar.helpers.DEFAULT_START_TIME
import org.pblmotion.calendar.helpers.DEFAULT_START_TIME_CURRENT_TIME
import org.pblmotion.calendar.helpers.DEFAULT_START_TIME_NEXT_FULL_HOUR
import org.pblmotion.calendar.helpers.DIM_COMPLETED_TASKS
import org.pblmotion.calendar.helpers.DIM_PAST_EVENTS
import org.pblmotion.calendar.helpers.DISPLAY_DESCRIPTION
import org.pblmotion.calendar.helpers.DISPLAY_PAST_EVENTS
import org.pblmotion.calendar.helpers.EVENTS_LIST_VIEW
import org.pblmotion.calendar.helpers.Formatter
import org.pblmotion.calendar.helpers.HIGHLIGHT_WEEKENDS
import org.pblmotion.calendar.helpers.HIGHLIGHT_WEEKENDS_COLOR
import org.pblmotion.calendar.helpers.IcsExporter
import org.pblmotion.calendar.helpers.LAST_EVENT_REMINDER_MINUTES
import org.pblmotion.calendar.helpers.LAST_EVENT_REMINDER_MINUTES_2
import org.pblmotion.calendar.helpers.LAST_EVENT_REMINDER_MINUTES_3
import org.pblmotion.calendar.helpers.LAST_VIEW
import org.pblmotion.calendar.helpers.LIST_WIDGET_VIEW_TO_OPEN
import org.pblmotion.calendar.helpers.LOOP_REMINDERS
import org.pblmotion.calendar.helpers.MONTHLY_DAILY_VIEW
import org.pblmotion.calendar.helpers.MONTHLY_VIEW
import org.pblmotion.calendar.helpers.PULL_TO_REFRESH
import org.pblmotion.calendar.helpers.REMINDER_AUDIO_STREAM
import org.pblmotion.calendar.helpers.REMINDER_OFF
import org.pblmotion.calendar.helpers.REPLACE_DESCRIPTION
import org.pblmotion.calendar.helpers.SHOW_GRID
import org.pblmotion.calendar.helpers.SHOW_MIDNIGHT_SPANNING_EVENTS_AT_TOP
import org.pblmotion.calendar.helpers.START_WEEKLY_AT
import org.pblmotion.calendar.helpers.START_WEEK_WITH_CURRENT_DAY
import org.pblmotion.calendar.helpers.USE_PREVIOUS_EVENT_REMINDERS
import org.pblmotion.calendar.helpers.VIBRATE
import org.pblmotion.calendar.helpers.WEEKLY_VIEW
import org.pblmotion.calendar.helpers.WEEK_NUMBERS
