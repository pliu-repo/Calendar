...
import org.pblmotion.calendar.activities.MainActivity
import org.pblmotion.calendar.activities.SimpleActivity
import org.pblmotion.calendar.databinding.AllDayEventsHolderLineBinding
...
import org.pblmotion.calendar.extensions.getWeeklyViewItemHeight
import org.pblmotion.calendar.extensions.intersects
import org.pblmotion.calendar.extensions.seconds
import org.pblmotion.calendar.extensions.shouldStrikeThrough
...
import org.pblmotion.calendar.views.ClickableRelativeLayout
...
class WeekFragment : Fragment(), WeeklyCalendar {
    ...
    private var dayColumns = ArrayList<ClickableRelativeLayout>()
    ...
    private fun addDayColumns() {
        ...
        (0 until config.weeklyViewDays).forEach {
            val column: ClickableRelativeLayout = WeeklyViewDayColumnBinding.inflate(
                layoutInflater,
                ...
                do {
                    ...
                    WeekEventMarkerBinding.inflate(layoutInflater).apply {
                        ...
                        val taskifyMeta = if (taskifyEventsMode && !event.isTask()) {
                            org.pblmotion.calendar.helpers.TaskifyHelper.parseTitle(event.title, taskifyModeEnabled = true)
                        } else {
                            null
                        }
